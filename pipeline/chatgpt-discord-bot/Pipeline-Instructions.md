...
aws ssm put-parameter \
    --name "/service/chatgpt-discord-bot/github/repo" \
    --description "Github Repository name for Cloudformation Stack chatgpt-discord-bot-pipeline" \
    --type "String" \
    --value "chatgpt-aws-discord-bot"

aws ssm put-parameter \
    --name "/service/chatgpt-discord-bot/github/token" \
    --description "Github Token for Cloudformation Stack chatgpt-discord-bot-pipeline" \
    --type "String" \
    --value "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"

aws ssm put-parameter \
    --name "/service/chatgpt-discord-bot/github/user" \
    --description "Github Username for Cloudformation Stack chatgpt-discord-bot-pipeline" \
    --type "String" \
    --value "TecHunter"
```

**NOTE:** Keep in mind that these Parameters will only be available within the same region you're deploying this Pipeline stack. Also, if these values ever change you will need to [update these parameters](https://docs.aws.amazon.com/cli/latest/reference/ssm/put-parameter.html) as well as update the "chatgpt-discord-bot-pipeline" Cloudformation stack.
...
aws cloudformation create-stack \
    --stack-name chatgpt-discord-bot-pipeline \
